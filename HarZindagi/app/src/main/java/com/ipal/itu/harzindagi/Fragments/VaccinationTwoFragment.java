 ...
 * Use the {@link VaccinationTwoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class VaccinationTwoFragment extends Fragment {
     ...
     * @return A new instance of fragment VaccinationTwoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static VaccinationTwoFragment newInstance(String param1, String param2) {
        VaccinationTwoFragment fragment = new VaccinationTwoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_vaccination_two, container, false);

        List<Injections> data= InjectionsDao.getInjectionsByVisit(2);
        // Injections ij=new Injections();
        //ij.SetInjections(1,"abc","aaaaaa",true);
        //data.add(ij);
        ListView list;
        list = (ListView) v.findViewById(R.id.list_v2);
       final VaccineAdapter adapter = new VaccineAdapter(getActivity(),R.layout.vaccinelist_item, data, "Har Zindagi");
        ...
        Button btn=(Button)v.findViewById(R.id.btn_v2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cameraIntent.putExtra("visit_num","2");
