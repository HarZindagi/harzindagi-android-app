 ...
 */
public class EvaccEPIListAdapter extends BaseAdapter {
    ...
    public EvaccEPIListAdapter(Context context, int xmlRowID, List<Evaccs> data, String app_name) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       // childName.setText(data.get(position).name);
        ...
        address.setText(data.get(position).epi_number);
        String imagePath = "/sdcard/" + app_name + "/"  + "Evac" +"/epi_" + Constants.getIMEI(context) + "_"+data.get(position).epi_number + ".jpg";
