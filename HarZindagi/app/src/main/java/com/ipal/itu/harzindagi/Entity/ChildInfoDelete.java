 ...
 */
@Table(name = "ChildInfoDelete")
public class ChildInfoDelete extends TruncatableModel{
...
/*    @Column(name = "book_update_flag")
    ...
    public ChildInfoDelete() {
        super();
    }

    public void setChildInfoDelete(String book_id, String childID, String name, int gender, String dob, String motherName, String guardianName, String CNIC, String phoneNum, long createdTime, String Location, String EpiName, String kidStation, String imageName, String nfcNumber, boolean recordFlag,boolean is_Delete, String address, String imei,long due_date,long next_visit_date) {
    ...
    public void setChildInfoDelete(String name, String CNIC, String phoneNum) {
        this.kid_name = name;
        this.guardian_cnic = CNIC;
        this.phone_number = phoneNum;
