 ...
 * Use the {@link VaccinationFiveFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class VaccinationFiveFragment extends Fragment {
    ...
    public VaccinationFiveFragment() {
     ...
     * @return A new instance of fragment VaccinationFiveFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static VaccinationFiveFragment newInstance(String param1, String param2) {
        VaccinationFiveFragment fragment = new VaccinationFiveFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       List<Injections> data= InjectionsDao.getInjectionsByVisit(5);
        // Injections ij=new Injections();
        //ij.SetInjections(1,"abc","aaaaaa",true);
        //data.add(ij);
        ListView list;
        list = (ListView) v.findViewById(R.id.list_v5);
       final VaccineAdapter adapter = new VaccineAdapter(getActivity(),R.layout.vaccinelist_item, data, "Har Zindagi");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cameraIntent.putExtra("visit_num","5");
